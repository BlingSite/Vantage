          ...
          >
            ...
            {view === VIEW.SIGN_IN && (
              <div className="mt-2 flex justify-end">
                <button
                  type="button"
                  onClick={() => { setView(VIEW.FORGOT); reset(); }}
            ...
            <button
              type="submit"
              disabled={busy}
              className="mt-4 flex w-full justify-center rounded-lg bg-gray-900 px-3 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-gray-800 disabled:opacity-50"
            >
              {busy
                ? "Please wait\u2026"
                : view === VIEW.SIGN_IN
